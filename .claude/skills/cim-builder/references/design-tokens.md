...
Measured directly from the OOXML of three reference decks — `Project_Gold_Mine` (the house
master template), `Project_Soul`, `Projeto_Biocap` — not estimated from PDFs. Counts are
...
Slide size **33.867 × 19.05 cm** = 13.333 × 7.5 in = 16:9. Identical in all three decks.

## 2. The two colors that survive every brand skin

| Token | Hex | Gold | Soul | Biocap |
|---|---|---|---|---|
| **IGC navy** | `#222F44` | 5 | 73 | 4 |
| IGC gold | `#D3A93D` | 2 | 19 | — |

Navy appears in all three decks despite three unrelated palettes — it is the house dark,
not a brand color. Gold is in two of three: signature, not universal.

Everything else is the target company's: Gold Mine `#FF0003` red · Soul `#07272D` teal +
`#EE5340` coral · Biocap `#AD6AC0` plum + `#F9EBEC` rose.
...
|---|---|---|
| **Left margin** | **2.03 cm** (0.8 in) | Most common shape origin: Gold 66× · Soul 87× · Biocap 33× |
